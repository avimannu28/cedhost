              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>              
                  <tr>
                    <?php 
                        foreach($_SESSION['datas'] as $key=>$value){
                            echo "<tr><td>$value[product_name]</td><td>$value[monthly_price]</td><td>$value[annual_price]</td><td>$value[webspace]</td><td>$value[band_width]</td><td>$value[freedomain]</td><td>$value[language]</td><td>$value[mailbox]</td><td><a href='?id=".$value['productid']."'>Delete</a></td></tr>";
                        }
                    ?>
                  <tr>
                </tbody>
