...
class Product
{
 ...
 public function add_sub_categories($category_id, $name, $link)
 {
  ...
  if ($result > 0) {
   ...
   $sql = mysqli_query($this->conn, "INSERT INTO tbl_product (prod_parent_id,prod_name,html,prod_available,prod_launch_date) VALUES ('$category_id','$name','$link','1',now())");
   return 1;
  }
 ...
 {
  $enter_into_category = mysqli_query($this->conn, "INSERT INTO tbl_product (prod_parent_id,prod_name,html,prod_available,prod_launch_date) VALUES ('$product_parent_id','$product_name','$product_url','1',now())");
